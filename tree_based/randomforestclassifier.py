import numpy as np
from .decisiontreeclassifier import DecisionTreeClassification
...
class RandomForestClassification:
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_estimators):
            ...
            estimator = DecisionTreeClassification()
            estimator.fit(
